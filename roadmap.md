...
- [ ] Corrigir seleção múltipla do catálogo com cores em texto, sem abrir variação no clique da caixa
- [ ] Testar marcação, cores repetidas, edição, remoção, envio e limite de 10; confirmar parâmetros dos filtros
