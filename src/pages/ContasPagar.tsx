        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Define o mês em que a despesa aparece no DRE. Para parcelas manuais, pode ser ajustada por parcela abaixo.
            </p>
          </div>
