...
export function SessoesDetalhe({ serie }: { serie: LinhaSessaoDia[] }) {
  ...
  const rastreioInflado = (l: LinhaSessaoDia) =>
    l.rastreio > 0 && l.rastreio_bruto > l.rastreio * 1.05;
                    ...
                    {rastreioInflado(l) && (
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span className="cursor-help text-xs text-muted-foreground line-through decoration-muted-foreground/60">
                            {fmtNum(l.rastreio_bruto)}
                          </span>
                        </TooltipTrigger>
                        <TooltipContent side="top" className="max-w-xs">
                          Sessões infladas por loop de rastreamento na /sale-elegant — excluídas automaticamente.
                        </TooltipContent>
                      </Tooltip>
                    )}
                  </span>
