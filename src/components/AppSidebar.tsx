...
const moduleGroups: ModuleGroup[] = [
  {
    ...
    icon: Compass,
    items: [
      { title: "Planejamento", url: "/gestao/planejamento", icon: CalendarDays },
      { title: "Mídia Paga", url: "/gestao/midia-paga", icon: Megaphone },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Dashboard do App", url: "/marketing/app-kpis", icon: BarChart3 },
